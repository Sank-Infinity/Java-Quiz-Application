...
public class FourFrame {
	...
	public FourFrame() {
		...
		l1 = new JLabel("QUE 3. What term describes the alignment of three celestial bodies?");
		l1.setBounds(50, 10, 500, 40);
		f.add(l1);
		
		r1 = new JRadioButton("A ) sizzle");
		r1.setBounds(200, 50, 150, 40);
		f.add(r1);
		
		r2 = new JRadioButton("B ) syzygy");
		r2.setBounds(200, 100, 150, 40);
		f.add(r2);

		r3 = new JRadioButton("C ) suzerainty");
		r3.setBounds(200, 150, 150, 40);
		f.add(r3);
		
		r4 = new JRadioButton("D ) symbology");
		...
		b2.addActionListener(new ActionListener(){  
			public void actionPerformed(ActionEvent e){  
				...
				JOptionPane.showMessageDialog(f, "Answer : B ) syzygy");
			}
		});
